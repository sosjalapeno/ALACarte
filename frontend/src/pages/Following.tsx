...
export function FollowingPage() {
    ...
    const reload = () => {
        ...
        api.following()
            ...
            .catch((err) =>
                setError(err.message || "Failed to load followed artists"),
            )
        ...
        <div className="mx-auto w-full max-w-7xl space-y-6 pt-4 md:pt-6">
            <AnimatePresence>
                {queuedCount > 0 && (
                    ...
                    >
                        <div>
                            Queued <b>{queuedCount}</b> release
                            {queuedCount === 1 ? "" : "s"}.{" "}
                            <Link
                                to="/"
            ...
            <section className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                <div className="space-y-2">
                    ...
                    <p className="max-w-2xl text-sm text-white/60 md:text-base">
                        Follow artists once and ALACarte will keep an eye out
                        for future releases.
                    </p>
                </div>
                <div
                ...
                <Card className="relative overflow-hidden p-8 md:p-10">
                    ...
                    <div className="relative max-w-xl space-y-3">
                        ...
                        <p className="text-sm text-white/60">
                            Open an artist page and use Follow to start watching
                            for new albums and singles.
                        </p>
                        <Link
                            to="/search"
